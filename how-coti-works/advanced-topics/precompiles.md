...
For more details about the `MpcInterface` contract, refer to the [**MpcInterface.sol**](https://github.com/coti-io/coti-contracts/blob/main/contracts/utils/mpc/README.md#mpcinterfacesol) file.
